...
function setupEnvironment() {
  ...
  export function resetTextureSizes() {
    parameterValues.canvas.width = Math.min(canvas.clientWidth * parameterValues.canvas.scale, 4320);
    parameterValues.canvas.height = Math.min(canvas.clientHeight * parameterValues.canvas.scale, 2480);
